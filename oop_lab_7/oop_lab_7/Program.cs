    ...
    static void Main()
    {
        try
        {
            ...
            while (true)
            {
                ...
                Console.WriteLine("12. Делить на 0");
        ...
        {
            Console.WriteLine("IndexOutOfRangeException: " + ex.Message); // недопустимый индекс.
        }
        catch (InvalidCastException ex)
        {
            Console.WriteLine("InvalidCastException: " + ex.Message); // приведение объекта к неправильному типу.
        }
        catch (OutOfMemoryException ex)
        {
            Console.WriteLine("OutOfMemoryException: " + ex.Message); // не хватает памяти
        }
        catch (OverflowException ex)
        {
            Console.WriteLine("OverflowException: " + ex.Message); // арифметическое переполнение
        }
        catch (Exception ex)
        {
